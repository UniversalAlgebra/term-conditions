...
%% wjd: temporarily inserting hyperref.  Remove before submitting to AU.
...
(Theorem~\ref{thm:F}).  %% We won't use anything in this subsection
...
\input{global-local-diff-term.tex}
