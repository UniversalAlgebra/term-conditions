...
$a_1 \neq b_1$.  
We have relegated this observation to a footnote because the efficiency gain
that it yields does not impact the overall complexity of our algorithm.} 
...
Using the subroutines from Subsection~\ref{sec:induct} 
...
Next, we use the subroutines in Subsection~\ref{sec:induct} 
