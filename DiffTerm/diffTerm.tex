...
Here are the steps that Stage 1 makes in order to compute a \ldto for 
...
\begin{algorithm}
  ...
  \KwOut{$p_{n^2} \in \dtr (Z_0 \cup U_{\ell})$}
...
\begin{algorithm}  
  ...
  \KwOut{$p_{n^2} \in \dtr \bigl\{(a_k, s_{k-1}(a_k, b_k, b_k), 0) \cup U_{\ell}\bigr\}$}
