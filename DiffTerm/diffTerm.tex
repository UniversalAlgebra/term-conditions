...
Define
\begin{align*}
\zeta_0 &:= \eta_0 = \dtr \{(a_0, b_0, 1), (a_0, b_0, 0)\}, \\
\zeta_1 &:= \dtr (a_1, b_1, 0), \; \zeta_2 := \dtr (a_2, b_2, 0), \dots, \;
\zeta_i := \dtr (a_i, b_i, 0), \dots,\\
\zeta_{\kk} &:= \bigcap_{0\leq i < k}\zeta_i
  =\dtr \{(a_0, b_0, 1), (a_0, b_0, 0), (a_1, b_1, 0), \dots, (a_{k-1}, b_{k-1}, 0) \}.
\end{align*}
