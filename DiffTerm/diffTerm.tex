...
Since $(\alpha,\beta)$ is type~2, $\beta$ is abelian over $\alpha$.
This implies $\beta'$ is abelian over $\alpha'$, (add a ref??) 
which implies the
