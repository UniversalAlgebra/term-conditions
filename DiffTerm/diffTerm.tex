...
$a_0/\delta_0 \times \{b_1\} \cap \Sg^{\alg{A}\times \alg{A}} (\triple)$. In other words it finds a \ldto for the set $\{(a_0, b_0, 0), (a_1, b_1, 1)\}$.
...
\begin{algorithm}
  ...
  \KwOut{$p_{n^2} \in \dtr (Z_0 \cup U_{\l})$}
...
\begin{algorithm}
\KwOut{$s_{n^2} \in \dtr (Z_{\ell} \cup U_{\ell})$}
