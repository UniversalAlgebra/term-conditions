...
% \end{cases}
% \end{align*}
Occasionally, the notation $(a,b,i)\rtimes t$ will serve as a convenient and equivalent alternative to $t\ltimes (a,b,i)$.
...
\begin{proof}
  ...
  $a, b \in A$ we have $a \comr{\thetaab} d(a,b,b)$, since 
  % $d \in \Inv{(a,b,0)}$, 
  $d \ltimes (a,b,0)$, and we have $d(a,a,b) = b$, since 
  % $d\in \Inv{(a,b,1)}$.
  $d\ltimes (a,b,1)$.
\end{proof}
% 
