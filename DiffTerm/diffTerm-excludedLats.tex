...
satisfying $\alpha < \beta$ and $\beta$ is abelian over $\alpha$,
where 
\begin{align*}
...
and $d=(y_0,y_1)$, and $\alg B$ is the subalgebra of $\alg A^2$ generated
by $a$, $b$, $c$ and $d$.
\end{enumerate}
\end{theorem}
...
where $\alpha \le \alpha' \cov \beta$. Since $[\beta,\beta] \le \alpha'$
...
\\[8pt]
{\bf TODO:} finish proof of Theorem~\ref{thm:conjecture}
