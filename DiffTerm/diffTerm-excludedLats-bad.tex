...
Then $e$ induces a latticehomomorphism of $\Con \alg A$ onto
$\Con \alg A |_{U}$ separating $\alpha$ from $\beta$. It 
...
We claim that for each~$i$ and for all $c\in \body(U)$ 
and all $v\in A$, we have
$(c, v) \in \beta \circ \rho_i \cap \rho_i \circ \beta$.


    
To prove this, we first note that 
$\beta \join \rho_i = 1_A$ implies
$\restr{\beta}{U} \join \restr{\rho_i}{U} = 1_U$, since $U = e(B)$.
Now, for all $x$, $y \in U$, if $x\in \body(U)$ 
and $y\in \tail(U)$, then
$(x,y) \notin \beta$.  Therefore,
$(x, y) \in  1_U = \restr{\beta}{U} \join \restr{\rho_i}{U}$ implies
there must be some $a \in \body(U)$ and $t\in \tail(U)$ such that 
$a \mathrel{\rho_i} t$.  
