...
% PRAVLJENJE NASLOVA
\begin{center}
{\large \bf ON THE COMPLEXITY OF DIFFERENCE TERM EXISTENCE\footnote{This is one place where you can put acknowledgement}
...
\\[2mm] {\it AMS Mathematics  Subject Classification $(2000)$}: 08B05, 08B10, 68Q25, 03C05 
% Please do not use not complete classification like 54Axx
\\[1mm] {\it Key words and phrases:} difference term, idempotent algebra, commutator
