...
\begin{enumerate}
\item compute $t_0$, a local difference term for
$\{(a_0, b_0, 0), (a_1, b_1, 1)\}$ using Subroutine 01.
\item compute $t_1$, a local difference term for
$\{(a_1, b_1, 1),  (a_2, b_2, 0)\}$, using
Subroutine 10.
\end{enumerate}
...
\noindent \underline{\textbf{Subroutine 101}}\\[4pt]
To find a local difference term operation for
$\{(a_0, b_0, 1), (a_1, b_1, 0),  (a_2, b_2, 1)\}$,
