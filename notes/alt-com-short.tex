...
\item
  ...
  an algorithm for computing the commutator might be based on the following formula:
  \begin{equation}
    \label{eq:5}
...
\begin{proof}\
  ...
  of $\Tol(A)$ as we now prove by checking that the following three conditions hold
  for all $T$, $T' \in \Tol(A)$:
  \begin{enumerate}[(c.1)]
